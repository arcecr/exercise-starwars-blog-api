...
Revision ID: 52621eb285a9
Revises: 
Create Date: 2021-03-04 16:53:46.284940
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('favvehicles')
    op.drop_table('favplanets')
    op.drop_table('favpersons')
